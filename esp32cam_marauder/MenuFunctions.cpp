          ...
          // Add SSID
            ...
            if (c_btn.justPressed()) {
              ...
              if (wifi_scan_obj.current_mini_kb_ssid != "") {
                pressed = true;
                ssid s = {wifi_scan_obj.current_mini_kb_ssid, (uint8_t)random(1, 12), {(uint8_t)random(256), (uint8_t)random(256), (uint8_t)random(256), (uint8_t)random(256), (uint8_t)random(256), (uint8_t)random(256)}, false};
                ssids->unshift(s);
                wifi_scan_obj.current_mini_kb_ssid = "";
              }
            }
